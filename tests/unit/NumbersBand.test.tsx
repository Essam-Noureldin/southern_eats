 ...
 *       - section heading carrying the "51 locations. 9 states" promise
...
describe("NumbersBand", () => {
  it("renders the pull-quote naming 51 locations and 9 states", () => {
    render(<NumbersBand />);
    expect(
      screen.getByText(/51 locations\.?\s*9 states/i),
    ).toBeInTheDocument();
  });
