...
export const menu: MenuItem[] = [
  ...
  { id: "fried-mushrooms", category: "appetizers", name: "Fried Mushrooms", description: "Hand-battered button mushrooms, fried crisp.", tags: [] },
  { id: "onion-rings", category: "appetizers", name: "Onion Rings", description: "Thick-cut onions, lightly battered and fried golden.", tags: [] },
  { id: "cheddar-poppers", category: "appetizers", name: "Cheddar Poppers", description: "Breaded cheddar cheese bites fried until molten inside.", tags: [] },
  { id: "cheese-sticks", category: "appetizers", name: "Cheese Sticks", description: "Mozzarella sticks, breaded and fried, with marinara.", tags: [] },
  { id: "appetizer-sampler", category: "appetizers", name: "Appetizer Sampler", description: "Pick any two starters from the list.", tags: [] },

  // Salads
  { id: "shrimp-salad", category: "salads", name: "Shrimp Salad", description: "Crisp greens topped with fried shrimp.", tags: ["shellfish"] },
  { id: "fish-salad", category: "salads", name: "Fish Salad", description: "Crisp greens topped with fried fish.", tags: [] },
  { id: "chicken-salad", category: "salads", name: "Chicken Salad", description: "Crisp greens topped with chicken strips.", tags: [] },
  { id: "green-salad", category: "salads", name: "Green Salad", description: "Mixed greens, tomato, cucumber, dressing of your choice.", tags: ["gf"] },
  ...
  { id: "four-piece-fish", category: "seafood", name: "Four Piece Fish", description: "Four fish fillets fried hot, with two Southern sides.", tags: [] },
  { id: "tilapia-platter", category: "seafood", name: "Tilapia Platter", description: "Cornmeal-crusted tilapia, with two Southern sides.", tags: [] },
  { id: "whole-catfish", category: "seafood", name: "Whole Catfish (2)", description: "Two whole catfish fried bone-in, with two Southern sides.", tags: [] },
  { id: "crab-cakes", category: "seafood", name: "Crab Cakes (3)", description: "Three pan-seared lump crab cakes, with remoulade.", tags: ["shellfish"] },

  // Seafood Combos
  { id: "fish-shrimp-combo", category: "combos", name: "Fish & Shrimp Combo", description: "One fish fillet and five jumbo shrimp, with two sides.", tags: ["shellfish"] },
  { id: "fish-oyster-combo", category: "combos", name: "Fish & Oyster Combo", description: "One fish fillet and four fried oysters, with two sides.", tags: ["shellfish"] },
  { id: "shrimp-oyster-combo", category: "combos", name: "Shrimp & Oyster Combo", description: "Five jumbo shrimp and four fried oysters, with two sides.", tags: ["shellfish"] },
  { id: "fish-shrimp-oyster-combo", category: "combos", name: "Fish, Shrimp & Oyster Combo", description: "One fish, four shrimp, four oysters. The full Sam's plate, with two sides.", tags: ["shellfish"], signature: true },
  ...
  { id: "chicken-wings", category: "chicken", name: "Chicken Wings", description: "Available in three or five pieces. Fried hot, served plain.", tags: [] },
  { id: "buffalo-wings", category: "chicken", name: "Buffalo Wings", description: "Tossed in classic Buffalo sauce. Three or five pieces.", tags: ["spicy"] },
  { id: "lemon-pepper-wings", category: "chicken", name: "Lemon Pepper Wings", description: "Dusted with cracked pepper and lemon. Three or five pieces.", tags: [] },
  { id: "fried-livers", category: "chicken", name: "Fried Livers", description: "Crispy fried chicken livers, a Southern classic.", tags: [] },
  { id: "fried-gizzards", category: "chicken", name: "Fried Gizzards", description: "Crispy fried chicken gizzards, slow-cooked tender.", tags: [] },
  { id: "liver-gizzard-combo", category: "chicken", name: "Livers & Gizzards", description: "Half livers, half gizzards. The full plate.", tags: [] },
  ...
  { id: "fried-chicken-poboy", category: "poboys", name: "Fried Chicken Po'Boy", description: "Hand-breaded fried chicken, dressed all the way on French.", tags: [] },
  { id: "gyro-poboy", category: "poboys", name: "Gyro Po'Boy", description: "Marinated gyro meat, lettuce, tomato, onion, tzatziki, on French.", tags: [] },
  ...
  { id: "philly-cheese-steak", category: "burgers", name: "Philly Cheese Steak", description: "Sliced ribeye, peppers, onions, melted provolone on a hoagie.", tags: [] },
  { id: "philly-chicken", category: "burgers", name: "Philly Chicken Sandwich", description: "Sliced chicken, peppers, onions, melted provolone on a hoagie.", tags: [] },
  ...
  { id: "family-fish-fry-24", category: "family", name: "Family Fish Fry (24 fillets)", description: "Twenty-four fillets, two large sides, hush puppies. Feeds 8–10.", tags: ["family-size"] },
  ...
  { id: "family-shrimp-40", category: "family", name: "Family Shrimp Boil (40)", description: "Forty jumbo shrimp, two large sides, hush puppies. Feeds 6–8.", tags: ["shellfish", "family-size"] },
  ...
  { id: "family-wing-dinner", category: "family", name: "Family Wing Dinner (20)", description: "Twenty wings, two large sides. Feeds 4–6.", tags: ["family-size"] },
  { id: "family-strip-dinner", category: "family", name: "Family Strip Dinner (20)", description: "Twenty chicken strips, two large sides. Feeds 4–6.", tags: ["family-size"] },
  ...
  { id: "mashed-potatoes", category: "sides", name: "Mashed Potatoes", description: "Buttery whipped potatoes with peppered cream gravy.", tags: ["gf"] },
  { id: "green-beans", category: "sides", name: "Green Beans", description: "Slow-cooked Southern style with smoked turkey.", tags: ["gf"] },
  { id: "mac-cheese", category: "sides", name: "Mac & Cheese", description: "Three-cheese blend, baked until bubbling.", tags: [] },
  ...
  { id: "kids-fish", category: "kids", name: "Kids Fried Fish", description: "Two fish fillets, fries, and a drink.", tags: [] },
  { id: "kids-nuggets", category: "kids", name: "Kids Chicken Nuggets", description: "Six nuggets, fries, and a drink.", tags: [] },
  { id: "kids-grilled-cheese", category: "kids", name: "Kids Grilled Cheese", description: "Classic grilled cheese, fries, and a drink.", tags: [] },
